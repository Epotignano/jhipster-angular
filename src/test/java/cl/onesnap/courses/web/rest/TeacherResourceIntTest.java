...
public class TeacherResourceIntTest {
    ...
    private static final LocalDate DEFAULT_BIRTDHDATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_BIRTDHDATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public void initTest() {
        ...
        teacher.setBirtdhdate(DEFAULT_BIRTDHDATE);
    }
    ...
    public void createTeacher() throws Exception {
        ...
        assertThat(testTeacher.getBirtdhdate()).isEqualTo(DEFAULT_BIRTDHDATE);
    }
    ...
    public void getAllTeachers() throws Exception {
        ...
        restTeacherMockMvc.perform(get("/api/teachers"))
                ...
                .andExpect(jsonPath("$.[*].birtdhdate").value(hasItem(DEFAULT_BIRTDHDATE.toString())));
    }
    ...
    public void getTeacher() throws Exception {
        ...
        restTeacherMockMvc.perform(get("/api/teachers/{id}", teacher.getId()))
            ...
            .andExpect(jsonPath("$.birtdhdate").value(DEFAULT_BIRTDHDATE.toString()));
    }
    ...
    public void updateTeacher() throws Exception {
        ...
        teacher.setBirtdhdate(UPDATED_BIRTDHDATE);
        ...
        assertThat(testTeacher.getBirtdhdate()).isEqualTo(UPDATED_BIRTDHDATE);
    }
